/*This problem is the same as the Filtered-LS but introduces the concept of
...
function parseAndLogData(err, mydata){
  if(err)
...
var mymodule = require('./module_modular.js')

mymodule(path, extension, parseAndLogData)
